 ...
 * 800 Unique Decisions (200 scenarios x 4 variants each)
 * Format: v2 (baseProfitPct * decisionQuality)
 */
...
const HARDCORE_NEW_DECISIONS = [
  {
    ...
    "category": "A1",
    "title": "顶级VC领投的A轮",
    "desc": "a16z领投，估值5000万，锁仓2年，技术团队来自Google Brain。模型已经跑通，但主网还需6个月。你作为个人LP有机会跟投500万额度。",
    "baseProfitPct": 2.5,
    "baseLossPct": 1.2,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "天使轮小份额机会",
    "desc": "估值800万，创始人是某交易所前CTO，产品只有Demo，无实际用户。给早期支持者10万U额度，风险极高但可能有百倍回报。",
    "baseProfitPct": 4.0,
    "baseLossPct": 2.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "种子轮最后窗口",
    "desc": "估值300万，团队背景一般但赛道是当下最热的AI Agent。明天就close，留给你的决策时间只有12小时。",
    "baseProfitPct": 3.5,
    "baseLossPct": 1.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "战略轮大额折扣",
    "desc": "估值1.2亿，已有测试网和1万用户，但主网上线还需18个月。某交易所承诺上所，要求锁仓3年。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "3年悬崖后缓慢释放",
    "desc": "前3年零流动性，第4年开始每月释放2%。项目不错，但5-7年才能全部退出，资金占用周期极长。",
    "baseProfitPct": 2.8,
    "baseLossPct": 1.4,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "对赌式解锁",
    "desc": "达到TVL 1亿解锁30%，用户10万再解锁30%。未达标则延长锁仓。项目方信心很足。",
    "baseProfitPct": 2.5,
    "baseLossPct": 1.2,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "无白皮书只有代码",
    "desc": "GitHub代码完整且质量高，但没有任何文档说明。技术人可以看懂，普通投资者一脸懵。",
    "baseProfitPct": 2.2,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "desc": "技术方案经过权威机构审计通过，但团队成员全部匿名。技术可信，人不可知。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "白皮书写得像科幻",
    "desc": "愿景宏大：构建星际区块链。落地路径模糊，实现时间表激进。概念炒作嫌疑很大。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "完全匿名的中本聪模式",
    "desc": "创始人身份不明，代码质量极高，已运行2年无事故。类似早期BTC，社区自治良好。",
    "baseProfitPct": 2.5,
    "baseLossPct": 1.2,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "部分实名部分匿名",
    "desc": "CEO实名露面，技术负责人坚持匿名。声称保护隐私，但投资者担心技术负责人突然消失。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "desc": "团队成员不公开，但代码和提案被以太坊基金会认可并资助。技术实力有据可查。",
    "baseProfitPct": 2.2,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "匿名且有Rug历史嫌疑",
    "desc": "社区怀疑是某Rug项目团队换马甲，部分链上行为相似，但没有确凿证据。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "三家顶级审计背书",
    "desc": "Trail of Bits、OpenZeppelin、CertiK都审计通过，无高危漏洞。代码质量业内顶尖。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "审计通过但有警告",
    "desc": "高危漏洞已修复，中低风险警告3个。项目方表示将在V2解决，目前可控。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "仅1家不知名审计",
    "desc": "审计公司没听说过，报价便宜，报告只有5页。其他大所拒绝审计，理由时间不够。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "审计报告未公开完整版",
    "desc": "只公布摘要，详细报告保密。理由涉及商业机密，但投资者无法全面了解风险。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C3",
    "title": "10万成员零机器人",
    "desc": "Discord 10万成员经检测全是真人，日均消息量适中，讨论质量高，无灌水。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C3",
    "title": "50万粉丝互动极低",
    "desc": "Twitter粉丝50万，但每条推文只有几十个赞。用工具检测发现90%是僵尸粉。",
    "baseProfitPct": 1.0,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C3",
    "title": "中文社区独大",
    "desc": "微信群500人每天999+消息极度活跃，但英文社区冷清。地域分布极不均衡。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C3",
    "title": "开发者社区繁荣",
    "desc": "GitHub contributors 100+，技术讨论热烈。但普通用户只有几千人，大众采用度低。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "种子轮估值1亿",
    "desc": "比同类项目A轮还贵，但赛道里这是唯一可投的龙头标的。稀缺性溢价极高。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "FDV 100亿起步",
    "desc": "fully diluted valuation极高，早期投资者已锁定10倍退出。你的轮次接盘感强烈。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "对标OpenAI估值",
    "desc": "AI+区块链概念，估值参照Web2巨头。但收入只有对方的万分之一，泡沫明显。",
    "baseProfitPct": 1.0,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B2",
    "title": "2年无退出渠道",
    "desc": "SAFT条款严禁转让，锁仓期内没有任何退出可能。即使项目成功，你也必须等到解锁。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B2",
    "title": "OTC限小额交易",
    "desc": "每次最多5万U，大额无法一次性退出。即使想出货，也要分几十次完成。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B2",
    "title": "转让需项目方批准",
    "desc": "找到买家后还需项目方同意转让。项目方有绝对控制权，买家资质审核权在项目方。",
    "baseProfitPct": 1.3,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "D1",
    "title": "链上大额转账预热",
    "desc": "项目方钱包近期频繁活动，大额转账到新地址。社区猜测是上所前准备，但不确认。",
    "baseProfitPct": 1.7,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C2",
    "title": "CTO被前雇主起诉",
    "desc": "知识产权纠纷，案件正在审理中。如果败诉，可能无法继续参与项目。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "上所顾问收费30万U",
    "desc": "声称有交易所关系，先付费后推进。这种收费模式风险极高，可能是骗局。",
    "baseProfitPct": 0.8,
    "baseLossPct": 0.4,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "社区投票决定上所",
    "desc": "DAO治理，上所决策由持币人投票。民主但效率低，可能错过最佳时机。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "MFN条款缺失",
    "desc": "后入场者条款可能更好，但你没有最惠国待遇保护。信息不对称风险大。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "反稀释保护",
    "desc": "如果后续融资估值更低，你可以获得补偿Token。下行风险有一定保护。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "无董事会席位",
    "desc": "纯财务投资，无治理权，信息获取完全依赖项目方主动披露。",
    "baseProfitPct": 1.4,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "清算优先权",
    "desc": "项目失败时，你优先拿回剩余资产。但最后能拿回多少很难说。",
    "baseProfitPct": 1.6,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "赛道已有3个独角兽",
    "desc": "Arbitrum、Optimism、Base已占据大部分市场。新进入者差异化不明显。",
    "baseProfitPct": 1.3,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "蓝海赛道首个进入者",
    "desc": "全新概念RWA+AI，无竞品，先发优势明显。但教育市场成本极高。",
    "baseProfitPct": 2.5,
    "baseLossPct": 1.2,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "1年悬崖后月解锁",
    "desc": "前12个月零流动性，之后每月释放8.33%。长时间资金锁定考验信念。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "TGE解锁20%然后悬崖",
    "desc": "先给一点甜头，之后1年无流动性。很多项目TGE后暴跌，20%可能也保不住。",
    "baseProfitPct": 1.6,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "里程碑式解锁",
    "desc": "主网上线解锁50%，生态TVL达1亿再解锁30%。与项目表现挂钩。",
    "baseProfitPct": 2.2,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "团队锁仓更长",
    "desc": "你锁1年，团队锁3年，核心成员锁4年。利益深度对齐，是好信号。",
    "baseProfitPct": 2.3,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "国库多签完全公开",
    "desc": "5/7多签，成员全部实名，所有链上操作可追踪。透明度高。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "国库大额转账到交易所",
    "desc": "近期频繁向币安、OKX转账大额USDT。疑似出货或支付上所费用，不明朗。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "季度财务报告",
    "desc": "类似上市公司披露，有收入、支出、资产负债表。透明专业。",
    "baseProfitPct": 2.1,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "第三方托管",
    "desc": "Fireblocks托管，项目方无法直接动用资金。安全性高但灵活性低。",
    "baseProfitPct": 1.9,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "完全放弃原方向",
    "desc": "180度转向，原产品停止维护。早期投资者是投的原方向，现在变了。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "社区投票决定Pivot",
    "desc": "DAO治理下的大方向调整，民主但决策慢。转型窗口期可能错过。",
    "baseProfitPct": 1.4,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E2",
    "title": "聘请顶级PR公司",
    "desc": "Wachsman PR，费用高昂，曝光度提升。但币圈对PR越来越免疫。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E2",
    "title": "创始人亲自做KOL",
    "desc": "个人IP强，Twitter粉丝百万。但项目独立性和持续性存疑。",
    "baseProfitPct": 1.6,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C2",
    "title": "创始人年薪5万U",
    "desc": "远低于市场水平，长期主义信号。但也要考虑生活压力导致的短期行为。",
    "baseProfitPct": 1.9,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C2",
    "title": "高管薪资对标谷歌",
    "desc": "顶级待遇，烧钱速度快。每年薪资支出就几百万U，资金消耗快。",
    "baseProfitPct": 1.4,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C2",
    "title": "Token占薪资50%",
    "desc": "现金少股权多，利益与项目深度绑定。短期生活压力大但激励对齐。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "交易销毁+回购双通缩",
    "desc": "每笔交易销毁0.1%，项目方定期回购销毁。但依赖交易量支撑。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "veToken模型",
    "desc": "锁仓越久收益越高，Curve模式。鼓励长期持有，减少抛压。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "无通缩纯增发",
    "desc": "持续通胀，每年增发10%。持有者被稀释，需要持续买入才能维持份额。",
    "baseProfitPct": 1.0,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "动态调整通胀率",
    "desc": "根据生态表现自动调整，表现好就减发，表现差就增发。机制复杂。",
    "baseProfitPct": 1.6,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "交易所战略轮",
    "desc": "某头部交易所战略投资，承诺上所。估值高但流动性有保障。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "社区轮开放散户",
    "desc": "额度小但门槛低，500U起投。FOMO机会但可能抢到即套牢。",
    "baseProfitPct": 1.4,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E2",
    "title": "与微软签署MOU",
    "desc": "合作开发企业级区块链解决方案，但MOU不具约束力，随时可取消。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E2",
    "title": "与某DeFi龙头合作",
    "desc": "集成对方协议，带来流量和技术背书。但对方随时可解除集成。",
    "baseProfitPct": 1.9,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E2",
    "title": "战略合作无具体细节",
    "desc": "宣布合作但无金额、无时间表、无具体产品。纯PR性质。",
    "baseProfitPct": 1.1,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E2",
    "title": "独家战略合作",
    "desc": "某领域唯一合作伙伴，排他性强。但对方实力一般，独家意义有限。",
    "baseProfitPct": 1.6,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B2",
    "title": "老股东折价20%出售",
    "desc": "急需用钱，OTC出售额度。项目基本面无变化，是捡漏机会。",
    "baseProfitPct": 2.2,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B2",
    "title": "OTC溢价购买",
    "desc": "项目热度高，有人愿意溢价30%买你的额度。卖还是不卖？",
    "baseProfitPct": 1.7,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B2",
    "title": "OTC交易方身份不明",
    "desc": "对方不愿透露身份，要求先转Token后付款。诈骗风险极高。",
    "baseProfitPct": 0.5,
    "baseLossPct": 0.2,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E1",
    "title": "治理攻击风险",
    "desc": "某鲸鱼持有15%代币，可能操纵投票结果。去中心化存疑。",
    "baseProfitPct": 1.3,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "SEC调查传闻",
    "desc": "市场传闻SEC正在调查该项目，但无官方确认。恐慌情绪蔓延。",
    "baseProfitPct": 1.0,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "证券属性模糊",
    "desc": "代币设计可能符合Howey测试，有被认定为证券的风险。",
    "baseProfitPct": 1.3,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "已获得监管许可",
    "desc": "某友好 jurisdiction 颁发牌照，合规运营。监管风险低。",
    "baseProfitPct": 2.1,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "desc": "APR 200%吸引大量资金，但不可持续，收益下降后可能撤资。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C2",
    "title": "友好分手",
    "desc": "成员离职但做好交接，持有Token锁仓不变。影响可控。",
    "baseProfitPct": 1.6,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E2",
    "title": "快照前大量资金涌入",
    "desc": "空投快照前TVL暴涨，疑似刷量。空投后可能大幅撤资。",
    "baseProfitPct": 1.4,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "叙事过时",
    "desc": "GameFi概念已冷却，项目还在主打Play2Earn。市场不买账。",
    "baseProfitPct": 0.9,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "创造新叙事",
    "desc": "提出全新概念DeFAI，市场尚未理解。教育成本高但先发优势大。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "审计发现高危漏洞",
    "desc": "可重入攻击风险，但尚未被利用。项目方承诺2周内修复。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "审计发现逻辑错误",
    "desc": "经济模型设计有缺陷，可能导致通胀失控。需要重新设计。",
    "baseProfitPct": 1.0,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C2",
    "title": "大厂高管背景",
    "desc": "前Google/Meta高级员工，技术强但创业是第一次。",
    "baseProfitPct": 1.9,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "D2",
    "title": "延长锁仓换奖励",
    "desc": "自愿延长锁仓6个月可获得额外5%Token。测试持有者信心。",
    "baseProfitPct": 1.9,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "D1",
    "title": "团队突然失联",
    "desc": "Discord、Twitter 3天无更新，团队不回应。危险信号。",
    "baseProfitPct": 0.5,
    "baseLossPct": 0.2,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "D1",
    "title": "代码不再更新",
    "desc": "GitHub 1个月无提交，开发停滞。项目可能被放弃。",
    "baseProfitPct": 0.7,
    "baseLossPct": 0.3,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B2",
    "title": "理论回报10倍",
    "desc": "基于对标公司估值，理论上可达10倍。但实现路径不清晰。",
    "baseProfitPct": 1.7,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A2",
    "title": "一次性销毁50%",
    "desc": "项目方销毁一半代币，通缩力度大。但可能是左手倒右手。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C3",
    "title": "雇佣水军刷热度",
    "desc": "Twitter、Discord机器人泛滥，虚假繁荣。",
    "baseProfitPct": 0.8,
    "baseLossPct": 0.4,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C2",
    "title": "获得行业巨头投资",
    "desc": "Coinbase Ventures投资，背书效应强。",
    "baseProfitPct": 2.2,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E1",
    "title": "锁仓期间无治理权",
    "desc": "锁仓Token不能投票，治理权只在流通Token中。",
    "baseProfitPct": 1.4,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C2",
    "title": "顾问无锁仓",
    "desc": "顾问Token TGE全额流通，投资者锁仓。不平等。",
    "baseProfitPct": 1.0,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "D1",
    "title": "巨鲸地址活跃",
    "desc": "dormant whale 重新活跃，可能有大动作。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "FDV 100亿",
    "desc": "fully diluted valuation极高，需要巨大成长空间。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "融资额远超需求",
    "desc": "实际只需要500万，却融了5000万，资金使用效率存疑。",
    "baseProfitPct": 1.3,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C3",
    "title": "无脑喊单",
    "desc": "大量'to the moon'、'diamond hands'，无实质内容。",
    "baseProfitPct": 0.9,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "3家顶级审计通过",
    "desc": "Trail of Bits、OpenZeppelin、CertiK都审计通过。",
    "baseProfitPct": 2.3,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "重复审计",
    "desc": "同一家审计公司审了3次，发现不同问题，代码质量存疑。",
    "baseProfitPct": 1.5,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "审计公司多次发现重大漏洞",
    "desc": "该审计公司曾多次在代码上线前发现高危问题，专业可靠。",
    "baseProfitPct": 2.2,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B3",
    "title": "5个赛道均衡配置",
    "desc": "DeFi、GameFi、AI、RWA、基础设施各20%。",
    "baseProfitPct": 1.9,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B3",
    "title": "Token+股权",
    "desc": "既有项目Token也有公司股权，双重 exposure。",
    "baseProfitPct": 2.1,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "SAFT+Token双轨",
    "desc": "既有SAFT未来获Token，又有一部分即时Token。",
    "baseProfitPct": 1.9,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A3",
    "title": "部分功能受限",
    "desc": "某些 jurisdiction 用户无法使用全部功能。",
    "baseProfitPct": 1.6,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "D2",
    "title": "名人背书质量高",
    "desc": "Vitalik、Elon Musk级别的背书，影响力大。",
    "baseProfitPct": 2.1,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "代码重构期",
    "desc": "技术团队决定暂停功能开发，用3个月重构底层架构，解决历史遗留问题。短期无新功能发布，市场热度可能下降。",
    "baseProfitPct": 1.7,
    "baseLossPct": 0.8,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "A1",
    "title": "无视技术债",
    "desc": "团队只追求快速上线，代码质量堪忧，随时可能出bug。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "多签+硬件钱包",
    "desc": "国库使用Gnosis Safe多签，私钥分散在多个硬件钱包，由不同人保管。",
    "baseProfitPct": 2.2,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E1",
    "title": "闪电贷攻击治理",
    "desc": "攻击者通过闪电贷获取大量Token，通过恶意提案转移国库资金。",
    "baseProfitPct": 0.5,
    "baseLossPct": 0.2,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "E1",
    "title": "治理时间锁",
    "desc": "提案通过后需等待3天执行，期间可取消，防止闪电贷攻击。",
    "baseProfitPct": 2.1,
    "baseLossPct": 1.1,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "D1",
    "title": "上所前团队成员买入",
    "desc": "链上数据显示团队钱包在所上前大量买入，内幕交易嫌疑。",
    "baseProfitPct": 1.0,
    "baseLossPct": 0.5,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B1",
    "title": "稳定币对无常损失小",
    "desc": "提供USDC/USDT LP，价格波动小，无常损失可忽略。",
    "baseProfitPct": 1.9,
    "baseLossPct": 0.9,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C3",
    "title": "被知名媒体黑",
    "desc": "Bloomberg发表负面报道，影响广泛，需要危机公关。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C3",
    "title": "创始人言论争议",
    "desc": "创始人在Twitter上发表争议言论，引发社区分裂。",
    "baseProfitPct": 1.3,
    "baseLossPct": 0.7,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B2",
    "title": "空投即触发税务",
    "desc": "收到空投即需按当时市价缴税，可能空投一文不值但要交税。",
    "baseProfitPct": 1.2,
    "baseLossPct": 0.6,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "C1",
    "title": "Chainlink喂价",
    "desc": "使用行业标准的Chainlink预言机，数据源可靠。",
    "baseProfitPct": 2.0,
    "baseLossPct": 1.0,
    "choices": [
      {
  ...
  },
  {
    ...
    "category": "B1",
    "title": "2倍杠杆做多",
    "desc": "使用2倍杠杆做多项目Token，收益放大但爆仓风险。",
    "baseProfitPct": 1.8,
    "baseLossPct": 0.9,
    "choices": [
      {
